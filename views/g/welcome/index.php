    ...
    <div class="container">
      <h2><?php l('news'); ?></h2>
<?php load_model('news', ['actor' => uri('actor'), 'class' => 'news', 'alias' => 'welcome_news', 'session' => ['limit' => 1]]); ?>
...
<?php endwhile; ?>
      ...
      <h2><?php l('post'); ?></h2>
<?php load_model('post', ['actor' => uri('actor'), 'class' => 'post', 'alias' => 'welcome_post', 'session' => ['limit' => 3]]); ?>
